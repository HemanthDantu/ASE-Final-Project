 ...
 */
public class RecyclerAdapterIng extends RecyclerView.Adapter<RecyclerAdapterIng.MyViewHolder> {

    private List<Landscape> mdata;
    private LayoutInflater mInflater;
    public static List<String> Favorites;
    public RecyclerAdapterIng(Context context, List<Landscape> data)
    {
        this.mdata = data;
