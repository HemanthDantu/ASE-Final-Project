...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {
    ...
    private List<SearchRecpie.Landscape> mdata;
    private LayoutInflater mInflater;
    public RecyclerAdapter(Context context,List<SearchRecpie.Landscape> data)
    {
        this.mdata = data;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        SearchRecpie.Landscape CurrentObj = mdata.get(position);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        CheckBox chkBox;
        int position;
        SearchRecpie.Landscape current;
        ...
        public void setData(SearchRecpie.Landscape currentObj, int position) {
            ...
            switch (v.getId())
            {
                ...
                case R.id.checkBox:
                    ...
                    else
                  {
                    ...
                    Toast.makeText(v.getContext(),mdata.get(position).getTitle()+ "is " + cb.isChecked(),Toast.LENGTH_LONG).show();
                   break;
                case R.id.heading:
